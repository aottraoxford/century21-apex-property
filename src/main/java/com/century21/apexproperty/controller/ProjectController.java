...
public class ProjectController {
    ...
    @PreAuthorize("hasAuthority('ADMIN') or hasAuthority('AGENT')")
    @DeleteMapping("/apis/slider/{id}")
    public ResponseEntity removeSlider(@PathVariable int id){
        projectService.removeSliderById(id);
        CustomResponse customResponse = new CustomResponse(200);
        return customResponse.httpResponse();
    }
    ...
    public ResponseEntity relatedProject(@RequestBody ProjectRelateRequest projectsRequest) {
    ...
    public ResponseEntity sliders(@ApiParam(allowableValues = "all,true,false") @RequestParam(required = false) String status, @RequestParam(value = "page", defaultValue = "1") int page, @RequestParam(value = "limit", defaultValue = "10") int limit) {
        Pagination pagination = new Pagination(page, limit);
    ...
    public ResponseEntity insertProject(@RequestBody ProjectRepo.ProjectInsertRequest project, @ApiIgnore Principal principal) {
        CustomResponse customResponse = new CustomResponse(200, projectService.insertProject(project, principal));
        return customResponse.httpResponse("result");
    }

    @PreAuthorize("hasAuthority('ADMIN')")
    @DeleteMapping("/apis/project")
    ...
    public ResponseEntity deleteProjectImage(@RequestParam("projectID") int projectID, @ApiParam("galleries file name") @RequestParam(value = "gallery", required = false) String galleryName) {
    ...
    public ResponseEntity projectDetail(@RequestParam int projectID, @ApiIgnore Principal principal) {
    ...
    public ResponseEntity projectListing(@ApiParam("search by title") @RequestParam(required = false) String title, @RequestBody ProjectRepo.ProjectListingRequest projectListingRequest, @RequestParam(value = "page", defaultValue = "1") int page, @RequestParam(value = "limit", defaultValue = "10") int limit) {
        Pagination pagination = new Pagination(page, limit);
